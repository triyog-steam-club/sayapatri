          ...
          <div className="bg-gradient-to-br from-gray-800/50 to-gray-900/50 backdrop-blur-sm rounded-3xl p-8 md:p-12 shadow-2xl border border-gray-700/50">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  <label className="block text-sm font-medium text-gray-300 mb-2">Student's Name *</label>
                  <input
                    type="text"
                    name="wardName"
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-300 mb-2">Student's Class *</label>
                  <input
                    type="text"
                    name="wardClass"
